...
void setup()
{
  ...
  if(canInit(0, CAN_BPS_125K) == CAN_OK)
    Serial.print("CAN0: .با موفقیت راه‌اندازی شد\n\r");
  else
    Serial.print("CAN0: .شکست در راه‌اندازی\n\r");
  delay(1000);
  if(canInit(1, CAN_BPS_125K) == CAN_OK)
    Serial.print("CAN1: .شکست در راه‌اندازی\n\r");
  else
...
void loop()
{
  ...
  while(1)  // Endless loop
  {
    ...
    {
      Serial.print("CAN0: پیام دریافت شد - ID: ");
    ...
    {
      Serial.print("CAN1: پیام دریافت شد - ID: ");
      Serial.print(lMsgID, HEX);
      //Serial.print(" Ext:");
      //Serial.print(bExtendedFormat);
      Serial.print(" Length: ");
